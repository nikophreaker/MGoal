...
import com.providoindodigital.mgoal.databinding.FragmentMyGamesBinding
...
class MyGamesFragment : Fragment() {
    private lateinit var viewBinding: FragmentMyGamesBinding
    ...
    override fun onCreateView(
        ...
        viewBinding = FragmentMyGamesBinding.inflate(inflater, container, false).apply {
    ...
    companion object {
        fun newInstance() = MyGamesFragment().apply {
